...
<body>
    ...
    <div id="contenido">
        ...
        <div class="boton--enviar"><button type="submit">Enviar</button></div>
        <?php
            date_default_timezone_set('America/Guatemala');    
            $DateAndTime = date("Y-m-d H:i:00",time()); 
            ...
            foreach ($grupos as $key => $value) {
                ...
                $query= "SELECT num_partido,nombre_h,nombre_a,TO_CHAR(fecha_hora, 'YYYY-MM-DD') as fecha, TO_CHAR(fecha_hora, 'HH:MI:SS')as hora,resultado_h,resultado_a,etapa,estadio FROM partido WHERE etapa='G$value' ORDER BY num_partido;";
                ...
                if(!$result){
                    ...
                    echo "<div class='partido'>
                                <div class='detalles'>
                                    ...
                                    <div class='dato'>GRUPO $value</div>
                                ...
                                <div class='resultados resultados--user'>
                                    <div class='punteo'>
                                        ...
                                        <div class='real valor'>
                                            <div class='res'> $resultado_h</div>-<div class='res'>$resultado_a</div>
                                        </div>
